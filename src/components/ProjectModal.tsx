...
import { X, Minimize2, Maximize2, ExternalLink, Github, Clock } from "lucide-react";
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0">
        {/* Project Image */}
        <div className={`relative w-full overflow-hidden bg-muted transition-all duration-300 ${isImageMinimized ? 'h-24' : 'h-64 md:h-80'}`}>
          <img
            src={project.image}
            alt={project.title}
